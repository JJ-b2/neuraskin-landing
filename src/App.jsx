  ...
  return (
    <div className="min-h-screen bg-[#f8f6f3] text-[#1e2b2d] flex flex-col items-center px-4 py-10">
      ...
      <div className="bg-white shadow-xl rounded-2xl p-6 w-full max-w-md">
        ...
        <input type="email" placeholder="Enter your email" className="mb-4 p-2 w-full border rounded" />
        <button className="w-full bg-black text-white py-2 rounded">Notify Me</button>
      </div>
